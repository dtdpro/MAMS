...
CREATE TABLE IF NOT EXISTS `#__mams_articles` (
  ...
  `art_title` varchar(1024) NOT NULL,
  `art_alias` varchar(1024) NOT NULL,
  `art_thumb` varchar(255) NOT NULL,
  `art_desc` text NOT NULL,
  `metadesc` text NOT NULL,
  `metakey` text NOT NULL,
  `art_content` longtext NOT NULL,
  `art_preview` longtext NOT NULL,
  ...
  `art_excluded` tinyint(1) NOT NULL DEFAULT '0',
  `art_hits` int(11) NOT NULL DEFAULT 0,
  `art_fielddata` text NULL,
  `art_showtitle` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `#__mams_article_fields` (
  ...
  `field_show_preview` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `#__mams_authors` (
  ...
  `auth_mirror` int(11) NOT NULL DEFAULT 0,
  `published` int(11) NOT NULL,
  `access` int(11) NOT NULL,
  `ordering` int(11) NOT NULL,
  `metakey` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__mams_cats` (
  ...
  `cat_redirurl` VARCHAR(1024) NULL,
...
CREATE TABLE IF NOT EXISTS `#__mams_secs` (
  ...
  `sec_content` longtext NOT NULL,
  `sec_image` varchar(255) NOT NULL,
  `sec_thumb` varchar(255) NOT NULL,
  `sec_redirurl` VARCHAR(1024) NULL,
...
CREATE TABLE IF NOT EXISTS `#__mams_tags` (
  ...
  `tag_redirurl` VARCHAR(1024) NULL,
...
CREATE TABLE IF NOT EXISTS `#__mams_track` (
  ...
  `mt_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `mt_ipaddr` varchar(255) NOT NULL,
  PRIMARY KEY (`mt_id`),
  KEY `mt_type` (`mt_type`),
  KEY `mt_item` (`mt_item`),
  KEY `mt_time` (`mt_time`)
...
INSERT INTO `#__mams_article_fieldgroups` (`group_id`, `group_name`, `group_title`, `group_show_title`, `ordering`, `access`, `published`,`params`) VALUES
