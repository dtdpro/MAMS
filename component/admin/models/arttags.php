...
class MAMSModelArttags extends JModelList
{
	...
	protected function getListQuery() 
	{
		...
		if (is_numeric($artId)) {
			$query->where('a.at_art = '.(int) $artId);
		}

		// Join over the authors.
		$query->select('tag.tag_title');
		$query->join('LEFT', '#__mams_tags AS tag ON tag.tag_id = a.at_tag');
