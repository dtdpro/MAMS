...
class MAMSViewField extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolBar() 
	{
		...
		$userId = $user->id;
		$isNew = $this->item->field_id == 0;
		JToolBarHelper::title($isNew ? JText::_('COM_MAMS_MANAGER_FIELD_NEW') : JText::_('COM_MAMS_MANAGER_FIELD_EDIT'), 'mams');
