...
if ($saveOrder) {
	$saveOrderingUrl = 'index.php?option=com_mams&task=artdloads.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'MAMSArtDloadList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
	...
	<table class="adminlist table table-striped" id="MAMSArtDloadList">
		<thead>
			<tr>
				...
				<th width="15%">
					<?php echo JText::_('COM_MAMS_ARTDLOAD_HEADING_FIELD'); ?>
				</th>		
				<th>
		...
		<?php foreach($this->items as $i => $item): ?>
			<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->ad_field; ?>">
