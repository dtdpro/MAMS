 ...
 * @since		1.0
 */
class MAMSViewMedia extends JView
{
	/**
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_MAMS_MEDIA_CREATING') : JText::_('COM_MAMS_MEDIA_EDITING'));
		$document->addScript(JURI::root() . $this->script);
		JText::script('COM_MAMS_MEDIA_ERROR_UNACCEPTABLE');
	}
}
