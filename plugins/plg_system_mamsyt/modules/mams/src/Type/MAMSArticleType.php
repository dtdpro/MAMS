...
class MAMSArticleType
{
    public static function config()
    {
        $config = [
            ...
            'fields' => [
                ...
                'firstTrackableLinkUrl' => [
                    'type' => 'String',
                    'metadata' => [
                        'label' => 'First Link URL - Trackable'
                    ],
                    'extensions' => [
                        'call' => __CLASS__ . '::resolveFirstTrackableLinkUrl'
                    ]
                ],
    ...
    public static function resolveFirstTrackableLinkUrl($obj, $args, $context, $info)
    {
        $fieldData = null;
        foreach ($obj->fields as $of) {
            if ($of->field_type == 'links') {
