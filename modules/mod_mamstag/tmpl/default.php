...
if ($params->get('show_image',0)) {
	...
	echo '<img src="'.$taginfo->tag_image.'" class="mams-featmod-image-img">';
...
if ($params->get('show_viewall',0)) {
	...
	echo '<a href="'.JRoute::_("index.php?option=com_mams&view=artlist&layout=tag&tagid=".$taginfo->tag_id.":".$taginfo->tag_alias).'" class="uk-button">'.$params->get('text_viewall',"View All").'</a>';
	echo '</div>';
}
echo '</div>';